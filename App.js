...
Mentorship for innovation and growth   </li>    </ul>     </p>
        ...
        <button className="join-btn">JOIN THE CREW</button>
      </div><br/><br/><br/><br/>
      ...
      <div className="team-container"><h1>MINDS BEHIND THE MAGIC</h1>
        ...
        <div className="row">
          {teamMembers3.map((member, index) => (
           ...
           <div className="card"><img src="MarsL(3rdR).png" className="logo" /></div>
      ...
      <div className="container2"><div className="joinn">JOIN</div>
